            ...
            <div class="card-body">
              <form action="Panel.php?modulo=Editarempleado" method="post">
                ...
                <div class="for-group">
                  ...
                  <input type="text" readonly name="num_docempleado" required="" class="form-control" pattern="[0-9]+" maxlength="20" minlength="6" value="<?php echo $row['num_docempleado']?>">
                </div>
                <div class="for-group">
                  <label>Fecha Nacimiento</label>
                  <input type="date" readonly name="fech_nacempleado" required="" class="form-control" value="<?php echo $row['fech_nacempleado'] ?>">
                </div>
                <div class="for-group">
                  <br>
