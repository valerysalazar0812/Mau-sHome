            ...
            <div class="card-body">
              <form action="Panel.php?modulo=Crearempleado" method="post">
                ...
                <div class="for-group">
                  ...
                  <input type="password" name="paswordempleado" class="form-control" minlength="7" maxlength="20" required="">
                </div>
                  <div class="for-group">
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="direccionempleado" class="form-control" required="" minlength="5">
                </div>
                <div class="for-group">
